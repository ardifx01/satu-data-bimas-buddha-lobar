@extends('layouts.app') {{-- Pastikan layout ini sesuai --}}
...
<div class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <div class="mb-6 text-center">
            ...
            <p class="text-sm text-gray-500">Masuk ke akun Satu Data Bimas Buddha</p>
        </div>
        ...
        <p class="mt-6 text-sm text-center text-gray-500">
            Belum punya akun? <a href="{{ route('register') }}" class="text-primary hover:underline">Daftar</a>
        </p>
    </div>
</div>
@endsection
